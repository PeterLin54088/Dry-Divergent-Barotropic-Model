export Filtered_Leapfrog, Update_Init_Step!, Get_Δt, Get_ξ, Compute_Spectral_Damping!,
       Filtered_Leapfrog!
...
function Filtered_Leapfrog(; robert_coef::Float64,
    ...
    time = start_time
    return Filtered_Leapfrog(robert_coef, damping_order, damping_coef, damping,
                             laplacian_eigen,
...
function Update_Init_Step!(; integrator::Filtered_Leapfrog)
    ...
    return integrator.init_step = false
end
...
function Filtered_Leapfrog!(integrator::Filtered_Leapfrog,
                            δQ::Array{ComplexF64,3},
                            Qp::Array{ComplexF64,3}, Qc::Array{ComplexF64,3},
                            Qn::Array{ComplexF64,3})
    init_step = integrator.init_step
